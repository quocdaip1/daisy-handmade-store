...
export function CheckoutPage() {
  ...
  const handlePreview = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setIsPreviewing(true); setError(''); setErrors((current) => ({ ...current, coupon: undefined }))
    try {
